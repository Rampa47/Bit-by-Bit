...
void Manager::handleComplaint(string c,int degree)
{
    ...
    if(c.compare("Service")==0)
    {
        ...
        cout<<"Further investigation will be done. We promise this Kind of behaviour from any of our stuff will not repeat itself."<<endl;
        cout<<"There will be a 10% discount for your order."<<endl;
    }
}