...
{
    // Simulate a period of being occupied by sleeping or performing other actions.
...
{
    int iterations = ThreadSleep::generateRandomNumber(1, 4); // Random number of iterations.
